...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-white border-b border-slate-200/80 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5 space-y-8 flex flex-col justify-center">
            <div>
              ...
              <ScrollReveal delay={0.2}>
                <h2 className="font-bebas text-5xl sm:text-6xl tracking-wider mt-2 mb-4 text-slate-900">
                  GET A FREE <span className="text-amber-600">QUOTE</span>
                </h2>
              </ScrollReveal>
            ...
            <div className="space-y-4">
              {[
                ...
                const extraProps = item.href ? { href: item.href, className: "hover:border-amber-500/30 transition-colors" } : {};

                return (
                  <ScrollReveal key={index} delay={0.1 * index} y={20}>
                    <Component
                      {...extraProps}
                      className={`flex items-center space-x-4 p-4 bg-slate-50 border border-slate-200/80 rounded-2xl shadow-sm ${
                        item.href ? "hover:border-amber-500/30 transition-colors cursor-pointer hover:bg-white" : ""
                      }`}
                    >
                      <div className="p-3 bg-white border border-slate-200 text-amber-600 rounded-xl shadow-sm">
                      ...
                      <div>
                        ...
                        <p className="text-base sm:text-lg font-bold text-slate-800 tracking-wide">
                          {item.text}
                        </p>
                      </div>
                    </Component>
          ...
          <div className="lg:col-span-7">
            <ScrollReveal delay={0.3} y={40} className="h-full">
              <div className="bg-white border border-slate-200 p-8 md:p-10 relative box-glow h-full min-h-[500px] flex flex-col justify-center rounded-2xl shadow-lg">
                {/* Decorative corners */}
                <div className="absolute top-0 left-0 w-6 h-[2px] bg-gold rounded-tl-2xl" />
                <div className="absolute top-0 left-0 w-[2px] h-6 bg-gold rounded-tl-2xl" />
                <div className="absolute bottom-0 right-0 w-6 h-[2px] bg-gold rounded-br-2xl" />
                <div className="absolute bottom-0 right-0 w-[2px] h-6 bg-gold rounded-br-2xl" />
                ...
                <AnimatePresence>
                  {isSuccess && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-white z-20 p-8 flex flex-col items-center justify-center text-center rounded-2xl"
                    >
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                      ...
                      <h3 className="font-bebas text-4xl tracking-wider text-slate-800 mb-2">
                        QUOTE REQUEST SENT!
                      </h3>
                      ...
                      <button
                        ...
                        className="bg-gold hover:bg-gold-hover text-black px-8 py-3 font-bold uppercase tracking-wider text-sm transition-all rounded-xl"
                      >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <h3 className="font-bebas text-3xl tracking-wider text-slate-800 border-b border-slate-100 pb-4 mb-6">
                    CARRIER APPLICATION
                  </h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        } hover:border-slate-350 focus:border-amber-500 focus:bg-white px-4 py-3 text-slate-800 text-sm focus:outline-none transition-all rounded-xl`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          onChange={handleInputChange}
                          className={`w-full bg-slate-50 border ${
                            errors.equipment ? "border-red-500" : "border-slate-200"
                          } hover:border-slate-350 focus:border-amber-500 focus:bg-white px-4 py-3 text-slate-800 text-sm focus:outline-none appearance-none transition-all rounded-xl`}
                        >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      className="w-full bg-slate-50 border border-slate-200 hover:border-slate-350 focus:border-amber-500 focus:bg-white px-4 py-3 text-slate-800 text-sm focus:outline-none transition-all resize-none rounded-xl"
