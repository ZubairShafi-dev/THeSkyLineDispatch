...
export default function Testimonials() {
  ...
  return (
    <section id="reviews" className="py-24 bg-slate-50 border-b border-slate-200/80 relative overflow-hidden">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <ScrollReveal delay={0.2}>
            <h2 className="font-bebas text-5xl sm:text-6xl tracking-wider mt-2 mb-4 text-slate-900">
              WHAT DRIVERS <span className="text-amber-600">SAY</span>
            </h2>
          </ScrollReveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((review, idx) => (
            <ScrollReveal
              ...
              delay={idx * 0.15}
              y={30}
              className="bg-white border border-slate-200/80 p-8 flex flex-col justify-between relative group hover:border-amber-500/35 transition-all duration-300 rounded-2xl shadow-sm hover:shadow-md"
            >
              {/* Corner quote icon */}
              <div className="absolute top-6 right-8 text-slate-100 group-hover:text-amber-600/10 transition-colors duration-300">
              ...
              <div>
                ...
                {/* Quote Text */}
                <p className="text-slate-600 text-sm leading-relaxed mb-8 italic relative z-10 font-medium">
              ...
              <div className="border-t border-slate-100 pt-4 mt-auto">
                <h4 className="font-bold text-slate-800 uppercase tracking-wider text-base">
                  {review.author}
                </h4>
                <p className="text-xs text-amber-600 font-semibold uppercase tracking-widest mt-0.5">
                  {review.title}
                </p>
              </div>
            </ScrollReveal>
